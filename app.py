...
# Farben definieren basierend auf Auswahl
if st.session_state.theme == "dark":
    bg_color = "#0e1117"        # Dunkler Hintergrund (Streamlit Default)
    card_bg = "#262730"         # Dunkle Karten
    text_color = "#ffffff"      # Weißer Text
    border_color = "#41444e"    # Dunkle Ränder
    shadow = "rgba(0,0,0,0.5)"
else:
    bg_color = "#f8f9fa"        # Heller Hintergrund
    card_bg = "#ffffff"         # Weiße Karten
    text_color = "#31333F"      # Dunkler Text
    border_color = "#e0e0e0"    # Helle Ränder
    shadow = "rgba(0,0,0,0.05)"

# --- CSS INJECTION ---
st.markdown(f"""
    <style>
    /* 1. App Hintergrund erzwingen */
    .stApp {{
    ...
    div.stButton > button {{
        ...
        font-weight: 600;
        margin-bottom: 10px;
        /* Buttons passen sich meist gut automatisch an, aber wir können nachhelfen */
    }}
    ...
    /* 4. MOBILE KARTEN (Dynamische Farben) */
    .mobile-card {{
    ...
    .step-highlight {{
        ...
        /* Hintergrund leicht rötlich im Lightmode, transparent im Darkmode */
        background-color: {"#fff0f0" if st.session_state.theme == "light" else "#2d2323"};
    }}
    ...
    div[data-testid="stMetricValue"] {{
        font-size: 2rem;
        color: #ff4b4b !important; /* Immer rot bleiben */
    }}
...
with st.sidebar:
    ...
    # Verwende 'toggle' statt checkbox für besseren Look
